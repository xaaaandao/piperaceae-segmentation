...
def evaluate(fold, model, x_train, x_val, x_test, y_train, y_val, y_test):
...
def unet_model(channel, img_size):
    input_img = tf.keras.layers.Input((img_size, img_size, channel), name="img")
